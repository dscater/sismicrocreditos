                    ...
                    <div class="col-md-12">
                        <div class="pasos">
                            <div
                                class="paso"
                                :class="{
                                    active: paso_actual == 1,
                                }"
                                @click="irPaso(1)"
                            >
                                <span class="nro_paso">1</span>
                                <span class="txt_paso"
                                    >Requisito de Pre Aprobación</span
                                >
                            </div>
                            <div
                                class="paso"
                                :class="{
                                    active: paso_actual == 2,
                                }"
                                @click="irPaso(2)"
                            >
                                <span class="nro_paso">2</span>
                                <span class="txt_paso"
                                    >Formulario de Cliente</span
                                >
                            </div>
                            <div
                                class="paso"
                                :class="{
                                    active: paso_actual == 3,
                                }"
                                @click="irPaso(3)"
                            >
                                <span class="nro_paso">3</span>
                                <span class="txt_paso">Monto y Plazo</span>
                            </div>
                            <div
                                class="paso"
                                :class="{
                                    active: paso_actual == 4,
                                }"
                                @click="irPaso(4)"
                            >
                                <span class="nro_paso">4</span>
                                <span class="txt_paso">Plan de Pagos</span>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                >
                                                    <input
                                                        type="checkbox"
                                                        id="checkboxPrimary1"
                                                        v-model="prestamo.f_ci"
                                                    />
                                                    <label
                                                        for="checkboxPrimary1"
                                                        >Fotocopia de C.I.
                                                    </label>
                                                </div>
                                                <span
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                >
                                                    <input
                                                        type="checkbox"
                                                        id="checkboxPrimary2"
                                                        v-model="prestamo.f_luz"
                                                    />
                                                    <label
                                                        for="checkboxPrimary2"
                                                        >Fotocopia de Luz
                                                    </label>
                                                </div>
                                                <span
                                    ...
                                    >
                                        ...
                                        <div
                                            class="row"
                                            v-if="prestamo && prestamo.cliente"
                                        >
...
export default {
    ...
    computed: {
        ...
        tituloPaso() {
            ...
            switch (this.paso_actual) {
                case 1:
                    titulo = "Requisito de Pre Aprobación";
                    break;
                case 2:
    ...
    methods: {
        buscarCliente() {
            if (this.txt_ci.trim() != "") {
                axios
                    .get(main_url + "/admin/clientes/buscar_ci", {
                        params: {
                            ci: this.txt_ci,
                        },
                    })
                    .then((response) => {
                        this.prestamo.cliente = response.data.cliente;
                    })
                    .catch((error) => {
                        if (error.response) {
                            if (
