...
<body>
    ...
    <div class="encabezado">
        ...
        <table>
            <tbody>
                ...
                <tr>
                    ...
                    <td colspan="3">{{ number_format($grupo->monto, 2, '.', ',') }} ({{ $literal_prestamo }})</td>
                </tr>
                <tr>
        ...
        <table class="firmas">
            <tbody>
                <tr>
                    <td class="top_punteado">{{ $grupo->nombre }}</td>
                    <td class="top_punteado">{{ $grupo->user_desembolso->full_name }}</td>
                </tr>
                <tr>
                    <td>REPRESENTANTE</td>
                ...
                <tr>
                    <td></td>
                    <td>{{ $grupo->user_desembolso->full_ci }}</td>
                </tr>
            </tbody>
        </table>
    </div>
