...
<head>
    <meta charset="UTF-8">
    <title>MorasPrestamosGrupal</title>
    <style type="text/css">
        * {
...
<body>
    ...
    @foreach ($grupos as $key => $value)
        <div class="encabezado">
            ...
            <h4 class="texto">MORAS PRÉSTAMOS GURPAL</h4>
        ...
        <table border="1" class="cliente">
            <tbody>
                ...
                <tr>
                    <td class="bold gray">INTEGRANTES: </td>
                    <td class="">
                        <ul style="padding-left: 10px;">
                            @foreach ($value->prestamos as $p)
        ...
        @php
            $plan_pagos_mora = App\Models\GrupoPlanPago::where('fecha_pago', '<', date('Y-m-d'))
