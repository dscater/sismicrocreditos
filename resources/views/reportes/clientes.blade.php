        ...
        <tbody>
            ...
            @foreach ($clientes as $value)
                <tr>
                    ...
                    <td class="centreado">{{ $value->full_ci }}</td>
                    <td class="centreado">{{ $value->dir }}</td>
                    <td class="centreado">{{ $value->cel }}</td>
                    <td class="centreado">{{ $value->fono }}</td>
                    <td class="centreado">{{ $value->edad }}</td>
                    <td class="centreado">{{ $value->referencia }}</td>
                    <td class="centreado">{{ $value->cel_ref }}</td>
                    <td class="centreado">{{ $value->parentesco }}</td>
